...
type LoginProps={
    ...
    setPassword:any,
    loginUser:any,
    toggleRememberMe:any,
    shouldRememberUser:boolean
}
function Login({toggleLoginScreen,setEmail,setPassword,loginUser,toggleRememberMe,shouldRememberUser}:LoginProps){
    return (
        <div
                ...
                <form className="space-y-4 md:space-y-6" action="#">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-start">
                            <div className="flex items-center h-5">
                                <input id="remember" aria-describedby="remember" type="checkbox" checked={shouldRememberUser} onClick={toggleRememberMe}
                    ...
                    <button type="submit"
                            className="w-full text-bg-danger bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none
                             ...
                             dark:hover:bg-primary-700 dark:focus:ring-primary-800" onClick={loginUser}>Sign in
                    </button>
                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                        Don’t have an account yet?
                        <span className="font-medium text-primary-600 hover:underline dark:text-primary-500"
                           onClick={toggleLoginScreen}>Sign
                            up</span>
                    </p>
                </form>
            </div>
