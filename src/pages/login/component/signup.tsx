...
function Signup({toggleSignupScreen,email,password,setEmail,setPassword,createUser}:SignupProps){
    return (
        <div
                ...
                <form className="space-y-4 md:space-y-6" action="#">
                    ...
                    <button type="submit"
                            ...
                            focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600
                             dark:hover:bg-primary-700 dark:focus:ring-primary-800" onClick={createUser}>Sign
                        in
                    </button>
                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                        Don’t have an account yet? <a href="#"
                                                      className="font-medium text-primary-600 hover:underline dark:text-primary-500" onClick={toggleSignupScreen}>Sign
                        up</a>
                    </p>
                </form>
            </div>
